...
(map! [remap evil-jump-to-tag] #'projectile-find-tag
      ...
      :gnvime "M-:" #'sea/open-scratch-buffer
      ...
      :ne "M-f"   #'swiper
      :ne "C-M-f" #'sea/toggle-fullscreen
      :n  "M-s"   #'save-buffer
      ...
      (:leader
        ...
        :desc "Toggle last popup"       :n "~"   #'sea/popup-toggle
        :desc "Eval expression"         :n "`"   #'eval-expression
        :desc "Blink cursor line"       :n "DEL" #'+sea/blink-cursor
        ...
        (:desc "previous..." :prefix "["
          ...
          :desc "Buffer"                :nv "b" #'sea/previous-buffer
        ...
        (:desc "next..." :prefix "]"
          ...
          :desc "Buffer"                :nv "b" #'sea/next-buffer
        ...
        (:desc "workspace" :prefix "TAB"
          ...
          :desc "Kill all buffers"         :n "x"   #'sea/kill-all-buffers
        ...
        (:desc "buffer" :prefix "b"
          ...
          :desc "Kill buffer"             :n "k" #'sea/kill-this-buffer
          :desc "Kill other buffers"      :n "o" #'sea/kill-other-buffers
          :desc "Save buffer"             :n "s" #'save-buffer
          :desc "Pop scratch buffer"      :n "x" #'sea/open-scratch-buffer
          :desc "Bury buffer"             :n "z" #'bury-buffer
          :desc "Next buffer"             :n "]" #'sea/next-buffer
          :desc "Previous buffer"         :n "[" #'sea/previous-buffer
          :desc "Sudo edit this file"     :n "S" #'sea/sudo-this-file)
        ...
        (:desc "help" :prefix "h"
          ...
          :desc "Reload theme"          :n  "R" #'sea//reload-theme
          :desc "Find library"          :n  "l" #'find-library
          :desc "Toggle Emacs log"      :n  "m" #'sea/popup-toggle-messages
          ...
          :desc "Describe sea setting" :n  "s" #'sea/describe-setting
          :desc "Describe sea module"  :n  "d" #'sea/describe-module
          ...
          :desc "What face"             :n  "'" #'sea/what-face
          :desc "What minor modes"      :n  ";" #'sea/what-minor-mode
          :desc "Info"                  :n  "i" #'info
          :desc "Toggle profiler"       :n  "p" #'sea/toggle-profiler)
        ...
        (:desc "toggle" :prefix "t"
          ...
          :desc "Line numbers"           :n "l" #'sea/toggle-line-numbers
          :desc "Fullscreen"             :n "f" #'sea/toggle-fullscreen
          :desc "Indent guides"          :n "i" #'highlight-indentation-mode
          :desc "Indent guides (column)" :n "I" #'highlight-indentation-current-column-mode
          :desc "Impatient mode"         :n "h" #'+impatient-mode/toggle
          :desc "Big mode"               :n "b" #'sea-big-font-mode
          :desc "Evil goggles"           :n "g" #'+evil-goggles/toggle))


      ;; --- Personal vim-esque bindings ------------------
      :n  "zx" #'sea/kill-this-buffer
      :n  "ZX" #'bury-buffer
      :n  "]b" #'sea/next-buffer
      :n  "[b" #'sea/previous-buffer
...
(map! (:map input-decode-map
      ...
      ;; jumping to eol.
      :i "C-a" #'sea/backward-to-bol-or-indent
      :i "C-e" #'sea/forward-to-last-non-comment-or-eol
      :i "C-u" #'sea/backward-kill-to-bol-and-indent
      ...
      :i [M-backspace]  #'sea/backward-kill-to-bol-and-indent
      ...
      :i "SPC"                          #'sea/inflate-space-maybe
      :i [remap delete-backward-char]   #'sea/deflate-space-maybe
      :i [remap newline]                #'sea/newline-and-indent

      (:after org
        (:map org-mode-map
          :i [remap sea/inflate-space-maybe] #'org-self-insert-command
      ...
      (:map (minibuffer-local-map
        ...
        "C-w" #'sea/minibuffer-kill-word
        "C-u" #'sea/minibuffer-kill-line
        "C-b" #'backward-word
        "C-f" #'forward-word
        "M-z" #'sea/minibuffer-undo)
      ...
      (:map tabulated-list-mode-map
        [remap evil-record-macro] #'sea/popup-close-maybe)
